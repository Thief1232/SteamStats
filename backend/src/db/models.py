...
class OwnedGame(Base):
    ...
    steam_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("steam_accounts.steam_id"), primary_key=True)
    app_id: Mapped[int] = mapped_column(Integer, ForeignKey("games.app_id"), primary_key=True)
